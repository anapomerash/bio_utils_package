...
def test_strict_filter_fastq():
    assert filter_fastq(EXAMPLE_FASTQ, length_bounds=1) == {}
    assert filter_fastq(EXAMPLE_FASTQ, gc_bounds=1) == {}
    assert filter_fastq(EXAMPLE_FASTQ, quality_threshold=101) == {}
